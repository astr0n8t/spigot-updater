"""
Plugin configuration for Spigot Updater
Copy this file to plugins.py and customize for your setup
"""

plugins = {
    # Example SpigotMC plugin (commented out)
    # 'Spartan': {
    ...
    'BTLP_Bungee': {
        ...
        'zip_path': r'BungeeTabListPlus-\S*\.jar',  # regex for versioned names
        'jar': 'BTLP-Bungee.jar'
    },
    'BTLP_Bukkit': {
        'source': 'spigot',
        ...
        'zip_path': r'BungeeTabListPlus_BukkitBridge-\S*\.jar',  # regex for versioned names
        'jar': 'BTLP-Bukkit.jar'
    },
    'Companies': {
        'source': 'spigot',
    ...
    'Left4Chat': {
        'source': 'github',
        'repo': 'left4craft/left4chat',  # renamed from 'repository'
        'asset': 'Left4Chat.jar',
        'jar': 'Left4Chat.jar'
    },
    'EssentialsX': {
        'source': 'github',
        'repo': 'essentialsx/essentials',  # renamed from 'repository'
        # 'asset': r'EssentialsX-\S*\.jar',  # regex for versioned names
        'asset': 'EssentialsX-{{tag}}.0.jar',  # {{tag}} placeholder for github
        'jar': 'EssentialsX.jar'
    },
    'ProtocolLib': {
        'source': 'github',
        'repo': 'dmulloy2/protocollib',  # renamed from 'repository'
